...
/// <summary>
/// Plays two voice lines sequentially when the scene starts for the Tea step.
/// </summary>
public class AvaTeaActivity : MonoBehaviour
{
    ...
    private IEnumerator PlayVoiceLines()
    {
        ...
        {
            Debug.LogWarning("AvaTeaActivity: AudioSource is not assigned!");
        }
    }
}
